...
">
        <div class="selection">
          ...
          <div> 
            ...
            <input type="text" class="border border-gray-400 w-6/12 outline-none p-2 rounded-md" spellcheck="false" autocomplete="off" id="image-query" bind:value={imageCategory}/>
          </div>
          <div class="my-2">
          ...
          <div>
            ...
            <input type="text" class="border border-gray-400 p-2  w-6/12 rounded-md outline-none" spellcheck="false" autocomplete="off" id="image-query" bind:value={imageInterval} />
          </div>
          <div class="mt-2">
            <label for="imagepath"> Unsplash API key</label>
            <input type="text" class="border border-gray-400 p-2  w-6/12 rounded-md outline-none" spellcheck="false" autocomplete="off" id="image-query" bind:value={apikey} />
          </div>


          <div class="mt-5">
            <button class="text-gray-100 py-2 px-10 mb-3 rounded-md bg-gray-500" on:click={handleSaveSetting}> Save </button>
            <button class="text-gray-100 py-2 px-10 mb-3 rounded-md bg-gray-500" on:click={handleRestoreSetting}> Restore config </button>
          </div>
        </div>
       </div>
    </div>
